...
LDFLAGS =-L/usr/local/lib -lSDLmain -lSDL2 -Wl,-framework,Cocoa -framework OpenGL -lIL
else
...
mc: $(MINECRAP_OBJS) libmc.a
	@$(CC) $(CFLAGS) $(DEBUG) -o $@ $(MINECRAP_OBJS) libmc.a $(LDFLAGS)

tests/test_chunk: src/test_chunk.o libmc.a
	@mkdir -p tests
	@$(CC) $(CFLAGS) $(DEBUG) -o $@ src/test_chunk.o libmc.a $(LDFLAGS)
